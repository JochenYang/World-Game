...
const AFRICA: ContinentContent = {
  ...
  timeline: [
    ...
    { year: -635_000_000, era: '成冰纪', title: '雪球地球',
      description: '【为什么】7 亿年前罗迪尼亚超大陆裂解，裸露的新生岩石大量风化吸收大气 CO₂，温室效应崩塌，全球气温骤降至 -50℃。' +
        '【怎么】约 6.35 亿年前冰川从两极延伸至赤道，整个地球被数公里厚的冰盖包裹，海洋表面彻底冻结——所谓"雪球"。' +
        '【影响】这一状态持续约 8500 万年，最终火山持续喷发释放的 CO₂ 重建温室效应，冰川消融触发寒武纪生命大爆发。' +
        '【轶事】纳米比亚沙漠曾发现冰川擦痕的岩石，证明非洲大陆确实曾被冰川覆盖。',
    ...
    { year: 1960, era: '独立浪潮', title: '非洲独立年',
      description: '【为什么】二战后非洲民族独立运动高涨，1958 年几内亚率先独立引发"多米诺骨牌效应"，殖民帝国已无力阻挡。' +
        '【怎么】1960 年仅一年就有 17 个非洲国家宣告独立，包括尼日尔、上沃尔特、刚果、索马里等，史称"非洲年"。' +
        '【影响】1960 年标志大英帝国、法兰西殖民帝国的瓦解——到 1990 年代纳米比亚独立，非洲殖民体系彻底终结。' +
        '【轶事】这 17 国独立日多被定在 1960 年的不同日期；但联合国将 8 月 31 日设为"非洲裔人日"，纪念全球非洲裔的历史贡献。',
      location: { lat: 0, lon: 20 } },
...
const ASIA: ContinentContent = {
  ...
  timeline: [
    ...
    { year: -3500, era: '青铜时代', title: '二里头夏都',
      description: '【为什么】20 世纪 50 年代史学家徐旭生在豫西调查"夏墟"时，发现了二里头遗址——它成为中国考古学验证夏王朝的关键钥匙。' +
        '【怎么】二里头遗址面积约 300 万平方米，年代约公元前 1750 年，宫殿区、青铜作坊、绿松石器物坑有序分布，是东亚最早的广域王权都城。' +
        '【影响】二里头出土的青铜爵、绿松石龙形器、玉璋礼器组合，证明夏代已具备"王朝"形态——它奠定了"中国"概念的物质基础。' +
        '【轶事】二里头绿松石龙形器由 2000 余片绿松石镶嵌而成，被誉为"中华第一龙"，是中华民族龙图腾最早的实物原型。',
    ...
    { year: 1857, era: '近代', title: '印度民族大起义',
      description: '【为什么】1857 年英国殖民者强令印度土兵（sepoy）使用涂有牛脂猪油的子弹，触发印度教与伊斯兰教士兵共同的宗教怒火。' +
        '【怎么】1857 年 5 月 10 日密拉特土兵率先起义，迅速蔓延至德里、勒克瑙、坎普尔等地，起义者拥立莫卧儿末代皇帝巴哈杜尔沙二世为帝。' +
        '【影响】起义虽被镇压，但英国东印度公司被撤销，印度由女王直接统治——这成为印度民族独立运动的起点。' +
        '【轶事】起义军曾在德里围攻英国使馆，英国援军通过"德里大突袭"解围时，士兵高喊"记住密拉特"成为英军口号。',
...
const EUROPE: ContinentContent = {
  ...
  timeline: [
    ...
    { year: -200_000_000, era: '侏罗纪', title: '索伦霍芬石灰岩',
      ...
      image: '/generated/archaeopteryx_001.jpg',
      artifacts: ['索伦霍芬始祖鸟化石'],
    ...
    { year: 1815, era: '近代', title: '维也纳体系',
      description: '【为什么】拿破仑战争席卷欧洲 20 年后，维也纳会议试图建立一个"不会再有拿破仑"的欧洲秩序。' +
        '【怎么】1815 年俄、奥、普、英四大战胜国主导召开维也纳会议；奥地利首相梅特涅提出"正统主义"与"势力均衡"原则，重新划分欧洲版图。' +
        '【影响】会议确立了"欧洲协调"机制——大国通过会议协商处理国际争端，避免全面战争，造就 19 世纪欧洲百年相对和平。' +
        '【轶事】维也纳会议期间，俄、奥、普三国君主秘密成立"神圣同盟"，以基督教名义维护君主制——被戏称为"保守主义者的俱乐部"。',
    ...
    { year: 1991, era: '现代', title: '苏联解体',
      description: '【为什么】1991 年苏联 GDP 已下滑 20%，民族矛盾与意识形态崩塌叠加，戈尔巴乔夫"新思维"改革打开失控闸门。' +
        '【怎么】1991 年 12 月 25 日戈尔巴乔夫辞职，苏联正式解体为 15 国；同年南斯拉夫内战爆发，分裂为 5 国，引发持续 10 年的战争。' +
        '【影响】欧洲版图重新洗牌，原华约国家纷纷加入欧盟与北约，2004 年最大一次东扩接纳 10 国，"新欧洲"诞生。' +
        '【轶事】苏联解体当天苏联国旗从克里姆林宫降下，这一幕被 CNN 全球直播——冷战时代就此终结。',
...
const NORTH_AMERICA: ContinentContent = {
  ...
  timeline: [
    { year: -1_700_000_000, era: '古元古代', title: '大峡谷基底',
      ...
      image: '/generated/grandcanyon_001.jpg',
      artifacts: ['大峡谷 毗湿奴片岩'],
    ...
    { year: -15_000, era: '更新世晚期', title: '克洛维斯文化',
      ...
      image: '/generated/clovis_001.jpg',
      artifacts: ['克洛维斯尖状器'],
      location: { lat: 36, lon: -107 } },
    { year: -13_000, era: '更新世晚期', title: '梅多克罗夫特岩棚',
      description: '【为什么】1930 年代以来"克洛维斯优先"模型认为人类约 1.3 万年前从亚洲经白令陆桥进入美洲，梅多克罗夫特遗址挑战了这一观点。' +
        '【怎么】1973 年宾州梅多克罗夫特岩棚出土的石器，最初被判定为 1.6 万年前——若属实，人类进入美洲的时间比传统认知早 3000 年。' +
        '【影响】这一发现促使学界重新思考美洲人类迁徙路线；尽管具体年代仍有争议，"前克洛维斯"人群的存在已成为研究共识。' +
        '【轶事】考古学家最初怀疑这是"晚期混入"的石器，但岩棚地层明确分层——这场争议催生了数十年的美洲史前考古大辩论。',
    ...
    { year: 1607, era: '殖民', title: '詹姆斯敦',
      description: '【为什么】1606 年伦敦弗吉尼亚公司筹集资金试图从北美获得烟草、黄金等财富——首批 104 名殖民者于 1607 年 5 月抵达切萨皮克湾。' +
        '【怎么】殖民者沿詹姆斯河建立三角形堡垒"詹姆斯敦"，但首年因饥荒、疾病和与原住民波瓦坦人的冲突，存活者不足一半。' +
        '【影响】约翰·罗尔夫引入西印度烟草品种后，詹姆斯敦凭借烟草贸易存活——这成为英属北美 13 个殖民地的第一块基石。' +
        '【轶事】考古学家在詹姆斯敦遗址挖出大量殖民地早期文物，包括著名的"斯塔福德郡陶罐"碎片——它原产英国，证明殖民地早期的贸易网络。',
    ...
    { year: 1865, era: '近代', title: '南北战争终结',
      description: '【为什么】1860 年代美国南北因奴隶制矛盾激化，林肯当选触发南方 11 州"美利坚联盟国"独立——美国陷入内战。' +
        '【怎么】1861-1865 年南北战争是工业革命时代最血腥的战争，南方以农业为主，北方以工业为主；1863 年葛底斯堡战役成为转折点。' +
        '【影响】1865 年南方投降，《宪法第十三修正案》废除奴隶制，联邦巩固——美国随后开启"镀金时代"，铁路、电报、石油工业爆发。' +
        '【轶事】林肯 1863 年的《解放奴隶宣言》只针对南方叛乱州——但它使南北战争从"统一战争"升华为"反奴战争"，重塑了战争的道义基础。',
      location: { lat: 38, lon: -77 } },
    { year: 1945, era: '现代', title: '超级大国',
      description: '【为什么】二战结束时美国拥有全球 50% 工业产出、独家核武器、强大海军——成为唯一真正具有全球投射能力的国家。' +
        '【怎么】1944 年布雷顿森林会议确立美元与黄金挂钩(35 美元/盎司)、其他货币与美元挂钩；1945 年联合国成立；1949 年北约成立。' +
        '【影响】美国主导建立战后国际秩序(Pax Americana)；同时与苏联开启 40 年冷战，两大阵营在核威慑下保持"恐怖平衡"。' +
        '【轶事】布雷顿森林体系运转 27 年，1971 年尼克松因越战财政赤字被迫宣布美元与黄金脱钩——这一天被法国财政部长德斯坦称为"美国的违约日"。',
      location: { lat: 38, lon: -77 } },
    { year: 1969, era: '现代', title: '阿波罗登月',
      description: '阿姆斯特朗踏上月球，"人类的一大步"，美国赢得太空竞赛。',
      location: { lat: 28, lon: -80 } },
    { year: 1994, era: '现代', title: 'NAFTA',
      description: '【为什么】冷战结束后区域经济一体化浪潮兴起，1990 年美国总统老布什提出"美洲事业倡议"——NAFTA 是其首块拼图。' +
        '【怎么】1992 年美、加、墨三国签署 NAFTA；1994 年正式生效，三国逐步取消关税，商品、服务、资本自由流通。' +
        '【影响】NAFTA 让三国成为全球最大自由贸易区之一；墨西哥制造业爆发性增长，但美国传统工业带（如底特律汽车业）受到冲击。' +
        '【轶事】NAFTA 是全球第一份把劳工权益、环保标准写入主条款的贸易协定，被后来 TPP、USMCA 沿用——特朗普 2017 年将其改组为 USMCA。',
